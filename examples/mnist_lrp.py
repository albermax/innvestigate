...
if __name__ == "__main__":
    ...
    models = {'mlp_2dense':         ([0, 1],                   2,             {'dense_units':1024, 'dropout_rate':0.25, 'activation':'relu'}),
              ...
              'pt_plos_long_relu':  ([-1, 1],                  0,             {}), #pre-trained model from [TODO enter DOI PLOS + TOOLBOX]
              'pt_plos_short_relu': ([-1, 1],                  0,             {}), #pre-trained model from [TODO enter DOI PLOS + TOOLBOX]
              'pt_plos_long_tanh':  ([-1, 1],                  0,             {}), #pre-trained model from [TODO enter DOI PLOS + TOOLBOX]
              'pt_plos_short_tanh':  ([-1, 1],                 0,             {}), #pre-trained model from [TODO enter DOI PLOS + TOOLBOX]
             }
